...
import { createTestInfo, getTestById, getTestType } from '../../../ActionFactory/apiActions'
...
function TestPortalMain() {
  ...
  return (
    <div className="grid-container-TestPortal ">
      ...
      <TestNavAndLeft setMcqopen={setMcqopen} testType={testType} handleTestType={handleTestType}/>
      ...
      >
        ...
        <DialogContent dividers>
          ...
          <TextField
            ...
            type="TestName"
            onChange={(event)=>handleSectionInfo(event.target.value,"sectionName")}
          />
          ...
          <TextField
            ...
            rows={3}
            sx={{ width: "100%" }}
            onChange={(event)=>handleSectionInfo(event.target.value,"sectionInstruction")}
          />
