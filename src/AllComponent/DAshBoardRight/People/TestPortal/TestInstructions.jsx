  ...
  return (
    <div>
     <Box className="stickyTopBox">
                ...
                <p>
                  ...
                  <span style={{ color: "#000" }}>
                    ...
                    <span>
                        ...
                        onClick={handleClickOpen}>Click here to add </Button>
      ...
      <BootstrapDialog
        ...
        open={open}
      >
        <DialogTitle sx={{ m: 0, p: 2, alignItems: "center", textAlign: "center" }} id="customized-dialog-title">
          Test Instructions
        </DialogTitle>
        <IconButton
          aria-label="close"
        ...
        <DialogContent dividers>
          <Typography gutterBottom>
            ...
            <Box className="testInstTextField"
      component="form"
      sx={{
    ...
    >
      <TextField id="outlined-basic" variant="outlined" />
        ...
        <DialogActions>
          <Button autoFocus onClick={handleClose} className="doneBtnInstPage">
            Done
          </Button>
        </DialogActions>
      </BootstrapDialog>
