...
const CreateCouponForm =({})=>{
  return (
    <Box className="courseMainTrack">
        ...
        <Typography fontWeight={600} required>Discount Type</Typography>
      ...
      >
        <FormControlLabel value="female" control={<Radio className="radio-icon"/>} label="Years / Months / days" />
        <FormControlLabel value="male" control={<Radio className="radio-icon"/>} label="Percent Discount" className="scndRadioBtn"/>
      </RadioGroup>
    </FormControl>
