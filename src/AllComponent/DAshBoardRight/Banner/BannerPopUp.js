  ...
  return (
    <>
      ...
      <SelectedCoursesPopup
        ...
        handleClickPopUps={handleClickPopUps}
      />
      {show ? (
        <React.Fragment>
          <Dialog
          ...
          >
                ...
                <div>
                  ...
                  >
                    ...
                    <InputBase
                      ...
                      inputProps={{
                        "aria-label": "search your course by name",
                      }}
                    />
                  </Paper>
                </div>
            ...
            <Box className="radioText">
              <div>
                <Typography>Courses (3)</Typography>
              </div>
                ...
                <Box sx={{ ml: 1 }}>
                  ...
                  >
                    ...
                    <Typography sx={{ fontSize: "0.9rem", color: "grey" }}>
                      Note: The Students will be able to see this link within
                      the app itself.
                    </Typography>
                  </FormControl>
                </Box>
